...
const ChatMultichoice: FC<TChatProps> = React.memo(({ libraryInputData, chatMiddleware }) => {
  const values = chatMiddleware!.currentChatBotQuestion!.myAnswer!.MULTICHOICE!.checkboxTitles!
  ...
  const onPress = React.useCallback(() => {
    ...
    chatMiddleware.sendAnswer(text, EBubbleType.TEXT)
