...
import { StyleSheet, Text, View, ScrollView, Dimensions, Platform, ViewPropTypes, ViewStyle } from 'react-native'
...
export default class ScrollPicker extends Component<ScrollPickerProps, ScrollPickerState> {
  static propTypes = {
  ...
  constructor(props: ScrollPickerProps) {
    ...
    this.wrapperHeight =
      this.props.wrapperHeight || (this.props.style ? this.props.style.height : 0) || this.itemHeight * 5
  ...
  private _renderItem(data: string, index: number) {
    ...
    let item = (
      <Text
        style={
          isSelected ? [ScrollPickerStyles.itemText, ScrollPickerStyles.itemTextSelected] : ScrollPickerStyles.itemText
        }
      >
        {data}
      </Text>
